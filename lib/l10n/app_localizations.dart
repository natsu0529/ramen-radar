...
import 'package:ramen_radar/l10n/app_localizations_en.dart';
import 'package:ramen_radar/l10n/app_localizations_ja.dart';
...
abstract class AppLocalizations {
  ...
  /// No description provided for @genreIekei.
  ///
  /// In en, this message translates to:
  /// **'Iekei'**
  String get genreIekei;

  /// No description provided for @genreJiro.
  ///
  /// In en, this message translates to:
  /// **'Jiro'**
  String get genreJiro;
  ...
  /// No description provided for @spotGradeLabel.
  ///
  /// In en, this message translates to:
  /// **'Spot grade'**
  String get spotGradeLabel;
  ...
  /// No description provided for @errorRankingFetch.
  ///
  /// In en, this message translates to:
  /// **'Failed to fetch ranking'**
  String get errorRankingFetch;
  ...
  /// No description provided for @errorPermissionDeniedForever.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @showingLastResults.
  ///
  /// In en, this message translates to:
  /// **'Showing last results'**
  String get showingLastResults;

  /// No description provided for @mapViewA11y.
  ///
  /// In en, this message translates to:
  /// **'Map view with {count} results'**
